	...
	<?php if(isset($_SESSION['userInfo']) && $_SESSION['userInfo']['user_authority'] == '9'){?>
	    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: white;">
    		<a class="navbar-brand" href="http://localhost:8712/fleamarket_parkcheolhwi/index.php">フリマシステム</a>
    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
    			<ul class="navbar-nav mr-auto">
    				...
    				<li class="nav-item"><a class="nav-link" href="http://localhost:8712/fleamarket_parkcheolhwi/user/listUser.php">ユーザー管理</a></li>
    			...
    			<ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
                            <a class="dropdown-item" href="http://localhost:8712/fleamarket_parkcheolhwi/user/detailUser.php">会員情報</a>
                            <a class="dropdown-item" href="http://localhost:8712/fleamarket_parkcheolhwi/user/logout.php">ログアウト</a>
                        </div>
                    </li>
    			</ul>	
    		</div>
    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
    			...
    			<ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
                            <a class="dropdown-item" href="http://localhost:8712/fleamarket_parkcheolhwi/user/detailUser.php">会員情報</a>
                            <a class="dropdown-item" href="http://localhost:8712/fleamarket_parkcheolhwi/inquiry/inquiry.php">お問い合わせ</a>
                            <a class="dropdown-item" href="http://localhost:8712/fleamarket_parkcheolhwi/user/logout.php">ログアウト</a>
                        </div>
                    </li>
    			</ul>	
	...
	<?php } else {?>
		<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
    			<ul class="navbar-nav mr-auto">
    				<li class="nav-item"><a class="nav-link" href="http://localhost:8712/fleamarket_parkcheolhwi/goods/goodsList.php">商品</a></li>
    				<li class="nav-item"><a class="nav-link" href="http://localhost:8712/fleamarket_parkcheolhwi/buy/nonUser.php">非会員購入リスト</a></li>
    			</ul>
    			<form class="form-inline my-2 my-lg-0">
    				<input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
    				<button class="btn btn-outline-success my-2 my-sm-0" type="submit">検索</button>
    			...
    			<ul class="navbar-nav">	
    				<li class="nav-item"><a class="nav-link" href="http://localhost:8712/fleamarket_parkcheolhwi/user/login.php">ログイン</a></li>
    				<li class="nav-item"><a class="nav-link" href="http://localhost:8712/fleamarket_parkcheolhwi/user/signup.php">会員登録</a></li>
    			</ul>	
    		</div>
    	</nav>
	<?php }?>
